            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 space-x-2">
                        ...
                        <a href="{{ route('prisoners.edit', $prisoner) }}" class="inline-block bg-yellow-400 hover:bg-yellow-500 text-white text-xs font-semibold px-3 py-1 rounded">Bewerken</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
